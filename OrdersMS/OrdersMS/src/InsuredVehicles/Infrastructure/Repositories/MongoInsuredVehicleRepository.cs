...
using OrdersMS.src.InsuredVehicles.Infrastructure.Models;

namespace OrdersMS.src.InsuredVehicles.Infrastructure.Repositories
{
    public class MongoInsuredVehicleRepository(MongoDbService mongoDbService) : IInsuredVehicleRepository
    {
        ...
        public async Task<List<InsuredVehicle>> GetAll(GetAllVehiclesQuery data)
        {
            ...
            var vehicles = vehicleEntities.Select(v =>
            {
                var vehicle = InsuredVehicle.CreateVehicle(
                    ...
                    Enum.Parse<VehicleSize>(v.GetValue("vehicleSize").AsString),
        ...
        public async Task<Core.Utils.Optional.Optional<InsuredVehicle>> GetById(string id)
        {
            ...
            var vehicle = InsuredVehicle.CreateVehicle(
                ...
                Enum.Parse<VehicleSize>(vehicleDocument.GetValue("vehicleSize").AsString),
        ...
        public async Task<Result<InsuredVehicle>> Save(InsuredVehicle vehicle)
        {
            ...
            var savedVehicle = InsuredVehicle.CreateVehicle(
                ...
                Enum.Parse<VehicleSize>(mongoVehicle.VehicleSize),
