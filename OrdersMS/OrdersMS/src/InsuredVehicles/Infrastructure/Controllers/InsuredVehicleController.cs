...
using OrdersMS.src.InsuredVehicles.Application.Commands.CreateInsuredVehicle;
using OrdersMS.src.InsuredVehicles.Application.Commands.CreateInsuredVehicle.Types;
using OrdersMS.src.InsuredVehicles.Application.Commands.UpdateInsuredVehicle;
using OrdersMS.src.InsuredVehicles.Application.Commands.UpdateInsuredVehicle.Types;
using OrdersMS.src.InsuredVehicles.Application.Queries.GetAll;
using OrdersMS.src.InsuredVehicles.Application.Queries.GetAll.Types;
using OrdersMS.src.InsuredVehicles.Application.Queries.GetById;
...
namespace OrdersMS.src.InsuredVehicles.Infrastructure.Controllers
{
    [Route("vehicle")]
    [ApiController]
